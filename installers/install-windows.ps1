...
$Wheel = Join-Path $ScriptDir "subreplace_studio-0.3.1-py3-none-any.whl"
if (-not (Test-Path $Wheel)) {
    $Wheel = Join-Path $RootDir "dist\subreplace_studio-0.3.1-py3-none-any.whl"
}
...
Write-Host "Installed SubReplace Studio 0.3.1"
